...
calcBtn.addEventListener("click", (e) => {
    ...
    imcInfo.innerText = classification.info;

    document.querySelector("#calc-container").classList.add("hide");
...
backBtn.addEventListener("click", () => {
    ...
    document.querySelector("#calc-container").classList.remove("hide");
});
